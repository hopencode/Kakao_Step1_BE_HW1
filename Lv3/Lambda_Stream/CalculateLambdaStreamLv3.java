...
public class CalculateLambdaStreamLv3 {
    ...
    private static Number getValidatedThreshold(Scanner scanner, String prompt) {
        Number num = 0;
        while (true) {
            System.out.print(prompt);
            String input = scanner.nextLine();
    ...
    public static void main(String[] args) {
        ...
        Number num1, num2, threshold, result = 0;
        String input;
        char operator;
        ...
        while(true) {
            ...
            threshold = getValidatedThreshold(scanner, "입력한 값보다 큰 결과값들을 출력합니다: ");
            calculator.printGreaterResults(threshold.doubleValue());
